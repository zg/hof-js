...
every=function(a,x){for(i in a)if(a[i]!==x)return false;return true}
...
none=function(a,x){for(i in a)if(a[i]===x)return false;return true}
product=function(s,e,f){f=f||function(x){return x};return fold(map(range(start,end+1),func),function(a,b){return a*b},1)}
...
some=function(a,x){for(i in a)if(a[i]==x)return true;return false}
sum=function(s,e,f){f=f||function(x){return x};return reduce(map(range(s,e+1),f),function(a,b){return a+b})}
