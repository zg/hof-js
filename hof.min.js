...
product=function(s,e,f){var f=f||function(x){return x};l=function(s,a){return(s>e?a:l(s+1,f(s)*a))};return l(s,1)}
...
sum=function(s,e,f){var f=f||function(x){return x};l=function(s,a){return(s>e?a:l(s+1,f(s)+a))};return l(s,0)}
